...
export const type = {
  // Display headings
  heroH1: "text-4xl md:text-6xl lg:text-7xl font-normal tracking-normal leading-[1.1]",
  h2: "text-[clamp(1.75rem,3.5vw,2.75rem)] font-normal tracking-normal leading-[1.1]",
  h2Lg: "text-3xl md:text-4xl font-normal tracking-normal",
  h2Hero: "text-[clamp(2.5rem,5.5vw,4.75rem)] font-normal leading-none tracking-normal",
  h3: "text-2xl md:text-3xl font-normal tracking-normal leading-tight",
  // Labels
