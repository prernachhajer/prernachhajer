    ...
    <div className="min-h-screen bg-background text-foreground">
        ...
        <div className={`${layout.container} mx-auto`}>
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fade}>
            ...
            <p className="text-muted-foreground max-w-2xl mb-12">
              A feed-driven homepage built for volume, not clarity. Everything lived in a single scroll — scores, articles, promos — with no separation of intent.
            </p>
          </motion.div>
      ...
      <Section label="05 — Design Decisions">
        <Prose>
          ...
          <p>Every redesign produces moments where the right answer isn't obvious. These are the ones that shaped the outcome most.</p>
        </Prose>
        {[
          {
          ...
          <motion.div key={idx} initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fade} custom={idx}
            ...
            <div className="grid md:grid-cols-3 gap-0.5 rounded-xl overflow-hidden">
              ...
              <div className="bg-foreground text-background p-10">
                ...
                <h4 className="text-lg italic text-background/70 mb-3 leading-snug" style={{ fontFamily: t.displayFont }}>{block.tradeoff.title}</h4>
        ...
        <div className={`${layout.container} mx-auto`}>
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fade}
            ...
            <div>
              ...
              <h2 className="text-2xl md:text-3xl font-normal tracking-[-0.025em] text-background/90 leading-tight" style={{ fontFamily: t.displayFont }}>
                Don't redesign the<br /><span className="text-primary italic">live score strip.</span>
              </h2>
            </div>
          ...
          <div className="flex flex-col gap-8 mb-12">
            {[
              ...
              <motion.div key={screen.year} initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fade} custom={i}
                ...
                <div className="rounded-xl overflow-hidden border border-background/[0.07] bg-[hsl(220,15%,11%)]"
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fade}>
            ...
            <div className="grid md:grid-cols-[1fr_140px] gap-10 items-center">
              <p className="text-sm text-background/50 leading-[1.85]">
                The live score strip was the <strong className="text-background/90 font-bold">highest-performing surface</strong> on the homepage. Across three redesigns, it was the one thing we chose not to rebuild. Not because we couldn't improve it — but because <strong className="text-background/90 font-bold">its familiarity was its strength</strong>. Users trusted it. It anchored every visit. Restraint, here, was a design decision.
              </p>
              <div className="text-center md:border-l md:border-background/[0.07] md:pl-9">
                <p className="text-5xl font-extrabold tracking-tight leading-none text-background/90" style={{ fontFamily: t.displayFont }}>
        ...
        <div className={`${layout.container} mx-auto mt-12 grid md:grid-cols-3 gap-4`}>
          {[
            ...
            <motion.div key={card.title} initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fade} custom={i}
              ...
              <span className={`${t.labelSm} px-3.5 py-1.5 rounded-full w-fit ${card.active ? "bg-[hsl(152,48%,90%)] text-[hsl(152,48%,20%)]" : "border border-border text-muted-foreground"}`}>
                {card.status}
              </span>
            </motion.div>
          ))}
