        ...
        <div className={`${layout.container} mx-auto`}>
          ...
          >
            <div>
              ...
              <h2
                className="text-2xl md:text-3xl font-normal tracking-[-0.025em] text-foreground/90 leading-tight"
                style={{ fontFamily: t.displayFont }}
              >
                Don't redesign the
                <br />
            ...
            <span className="inline-flex items-center gap-2 text-[0.6562rem] font-mono tracking-[0.07em] text-[hsl(152,48%,25%)] bg-[hsl(152,48%,90%)] border border-[hsl(152,48%,80%)] rounded-full px-4 py-2 mt-1">
              ✓ Sustained 2021–2026
            </span>
          </motion.div>
            ...
            {[
              ...
              >
                <div className="pt-4 flex flex-col items-center gap-2.5">
                  <span className="text-sm font-mono font-medium tracking-[0.1em] text-foreground/90">
                    {screen.year}
                  </span>
                  ...
                  {i < 2 && (
                    <div className="w-px flex-1 min-h-[40px] bg-gradient-to-b from-border/50 to-transparent" />
                  )}
                </div>
                <div
                ...
                >
                  <div className="bg-muted/50 border-b border-border/50 px-3.5 py-2.5 flex items-center gap-3">
                    <div className="flex gap-1.5">
                      <div className="w-[10px] h-[10px] rounded-full bg-[#FF5F57]" />
                      <div className="w-[10px] h-[10px] rounded-full bg-[#FFBD2E]" />
                      <div className="w-[10px] h-[10px] rounded-full bg-[#28C840]" />
                    </div>
                    <div className="flex-1 bg-muted/60 border border-border/50 rounded-md px-3 py-1">
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fade}>
            <hr className="border-t border-border/50 mb-8" />
            <div className="grid md:grid-cols-[1fr_140px] gap-10 items-center">
              ...
              <div className="text-center md:border-l md:border-border/50 md:pl-9">
                <p
                  className="text-5xl font-extrabold tracking-tight leading-none text-foreground/90"
                  style={{ fontFamily: t.displayFont }}
                >
