...
const heroPill =
  "inline-flex items-center bg-background border border-foreground/15 rounded-full px-6 py-3 text-[36px] font-light text-foreground whitespace-nowrap leading-none";
      ...
      <section id="hero" className=" border-b border-border overflow-hidden">
        <div className={`${wrapCls}  md:pt-4 pb-4 md:pb-8 w-full`}>
          ...
          <div className="relative">
            ...
            <div className="relative  w-full md:min-w-[200px] min-h-[500px] mt-[0px] md:min-h-[480px]">
              <HeroDrop
                variant="photos"
                target={comp.photos}
                heavy
