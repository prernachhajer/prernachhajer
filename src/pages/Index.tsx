      ...
      <section id="hero" className=" border-b border-border overflow-hidden">
        <div className={`${wrapCls}  md:pt-4 pb-4 md:pb-8 w-full`}>
          ...
          <div className="relative">
            ...
            <div className="relative w-full min-h-[500px] mt-[-50px] md:min-h-[480px]">
              <HeroDrop
                variant="photos"
                target={comp.photos}
                heavy
  ...
  "
        ...
        "
            ...
            <div className={`${wrapCls} pb-12 pt-12 md:pb-16 w-full`}>
              {/* Two-column intro */}
              <div className="mt-8 md:mt-12 grid grid-cols-1 md:grid-cols-2 gap-16 md:gap-16 w-full max-w-[1024px] mx-auto">
