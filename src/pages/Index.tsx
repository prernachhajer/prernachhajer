...
const caseStudies = [
  {
    ...
    gradient: "linear-gradient(135deg,#131110,#1e1a14,#291a0e)",
    thumbWord: "Home",
    thumbWordLight: true,
    statNum: "5 yrs",
  ...
  },
  {
    ...
    gradient: "linear-gradient(135deg,#eae5dc,#d6cfc4,#c8bfb0)",
    thumbWord: "System",
  ...
  },
  {
    ...
    gradient: "linear-gradient(135deg,#0e1118,#141d2a,#1a2638)",
    thumbWord: "Quick",
    thumbWordLight: true,
    statNum: "↑",
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section id="about" className={`${surface.dark} relative overflow-hidden py-[clamp(96px,11vw,160px)]`}>
        ...
        <div className={`${wrapCls} relative z-[2]`}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-[clamp(48px,8vw,96px)]">
            {/* Left: headline + bio */}
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fade}>
              <h2
                      ...
                      >
                        <div className="flex flex-col gap-1 flex-1 min-w-0">
                          <span className="text-[17px] font-normal tracking-[-0.01em] text-background/[0.92] flex items-center gap-2" style={{ fontFamily: t.displayFont }}>
                            {exp.current && <span className="w-[6px] h-[6px] rounded-full bg-primary animate-pulse shrink-0" />}
                            {exp.company}
                          </span>
