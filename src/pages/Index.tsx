      ...
      <section id="hero" className=" border-b border-border overflow-hidden">
        <div className={`${wrapCls}  md:pt-4 pb-4 md:pb-8 w-full`}>
          ...
          <div className="relative">
            ...
            <div className="relative  w-full md:min-w-[232px] min-h-[500px] mt-[0px] md:min-h-[380px]">
              <HeroDrop
                variant="photos"
                target={comp.photos}
                heavy
  ...
  "
              >
                <HeroDrop variant="pillA" target={comp.tag1} delay={0.18}>
                  <span className={`${heroPill} border-1 border-neutral-600 px-3 py-4 `}>product designer</span>
                </HeroDrop>
