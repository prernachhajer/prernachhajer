...
import problemChartAsset from "@/assets/app-rating/content_strength_vs_problem_areas_v3.svg.asset.json";
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className={`${spacing.sectionGap} ${layout.px} border-t border-border`}>
        <div className={`${layout.container} mx-auto`}>
          ...
          <div className="max-w-3xl  mx-auto mt-14 md:mt-24">
            <p className={`${t.labelSm} text-muted-foreground mb-6`}>
              LEARNING FROM USER FEEDBACK ACROSS CRICINFO, CRICBUZZ AND GOOGLE
            </p>
          </div>
          <div className="max-w-3xl mx-auto mt-3 md:mt-3 mb-10 bg-white p-4 border rounded-xl">
