      ...
      <section className={`${spacing.sectionGap} ${layout.px} border-t border-border`}>
        <div className={`${layout.container} mx-auto`}>
          ...
          <div className="grid md:grid-cols-2 mt-14 md:mt-16">
            ...
            <div className="flex flex-wrap gap-x-2 gap-y-2 justify-center mt-10">
              {[
                ...
                <span
                  key={tag}
                  className={`${t.labelSm} h-8 px-4 py-2 rounded-full border border-border bg-secondary text-muted-foreground`}
                >
                  {tag}
                </span>
              ))}
