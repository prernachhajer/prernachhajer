    ...
    <div className="min-h-screen bg-background text-foreground">
        ...
        <div className={`${layout.container} mx-auto`}>
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fade}>
            ...
            <p className="text-muted-foreground max-w-2xl mb-12">
              In 2021, ESPN Cricinfo was scaling in every direction at once. We had a Figma component library — but it was undocumented, and not built for what was coming. Dark mode, native mobile, Tailwind migration. Incremental fixes wouldn't hold.
            </p>
          </motion.div>
      ...
      <section className={`${spacing.sectionGap} ${layout.px} ${surface.dark} border-t border-background/10`}>
        <div className={`${layout.container} mx-auto`}>
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fade}
            ...
            <p className="text-xs italic text-muted-foreground/60 leading-relaxed">50% faster design cycles and 170+ files are the clearest signals. Team independence and onboarding speed are directional — consistent across feedback but not formally benchmarked.</p>
          </motion.div>
        </div>
      </section>
      ...
      <Section label="05 — Phase 3: Make It Self-Sufficient">
        ...
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fade}
          ...
          <div className="rounded-xl border border-border/30 overflow-hidden" style={{ minHeight: "580px", maxHeight: "580px", overflowY: "auto" }}>
      ...
      <Section label="07 — Phase 5: The Overhaul">
        ...
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fade}
          ...
          <img src={fontExploration} alt="Typography exploration showing font candidates side by side" className="w-full my-0 mx-0 px-[20px] py-[20px] border border-solid rounded-lg bg-[#2b2b2b]/[0.91]" />
